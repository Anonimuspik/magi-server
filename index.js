...
// Правила чата
const rules = [
  { name: "Ссоры", points: 1, punishment: "мут 15–60 минут", desc: "Начало или продолжение конфликта" },
  ...
  { name: "Недостоверная информация", points: 1, punishment: "мут 15–60 минут", desc: "Ложные обвинения, клевета" },
...
Проанализируй жалобу по правилам чата (см. список ниже). 
Выбери нарушения, начисли баллы и предложи наказание (смягчи наказание, если можно).
Объясни в reasoning, почему так решил.
Текст жалобы: "${text}"
